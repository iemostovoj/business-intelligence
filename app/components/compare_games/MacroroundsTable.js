...
class MacroroundsTableHead extends React.Component {
...
//----MacroroundsTableHead----//
MacroroundsTableHead.propTypes = {
...
class MacroroundsTable extends React.Component {
    state = {
        order: 'asc',
        orderBy: 'name',
...
MacroroundsTable.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(MacroroundsTable);
