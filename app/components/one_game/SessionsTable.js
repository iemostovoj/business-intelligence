...
class SessionsTableHead extends React.Component {
    createSortHandler = property => event => {
        this.props.onRequestSort(event, property);
    };

    rows = [
        { id: 'sessions', numeric: true, disablePadding: false, label: 'Количество сессий' },
        { id: 'count', numeric: true, disablePadding: false, label: 'Количество игроков' },
        { id: 'percent', numeric: true, disablePadding: false, label: 'Количество игроков %' },
    ];
