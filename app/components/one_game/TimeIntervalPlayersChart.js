...
class TimeIntervalPlayersChart extends React.Component {
	displayName = 'TimeIntervalPlayersChart';
    ...
    getData = (data) => {
        return {
            ...
            datasets: [
                {
                    label: 'Количество игроков в сутки',
...
export default TimeIntervalPlayersChart;