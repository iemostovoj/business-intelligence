...
class CurrenciesTableHead extends React.Component {
    ...
    getColumns = () => {
        let columns = [
            ...
            { id: 'mr_percent', numeric: true, disablePadding: false, label: '% Макрораундов' },
            { id: 'bets_percent', numeric: true, disablePadding: false, label: '% Ставок' },
