...
class BetRateTableHead extends React.Component {
    createSortHandler = property => event => {
        this.props.onRequestSort(event, property);
    };

    rows = [
        { id: 'min_max', numeric: false, disablePadding: false, label: 'Размер ставки' },
        { id: 'count', numeric: true, disablePadding: false, label: 'Количество' },
        { id: 'percent', numeric: true, disablePadding: false, label: 'Количество %' },
    ];
...
class BetRateTable extends React.Component {
    state = {
        order: 'asc',
        orderBy: 'name',
...
BetRateTable.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(BetRateTable);
